  ...
  <div class="container-md my-5 py-5">
    <div class="recipe-title text-center">
      ...
      <p style="font-size: 15px">
        Find and share everyday cooking inspiration on Allrecipes. Discover recipes, cooks, videos, and how-tos based on
        the food you love and the friends you follow.
      </p>
    </div>
