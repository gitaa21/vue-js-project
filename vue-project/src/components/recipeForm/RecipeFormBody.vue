  ...
  <li class="list-group-item">
    <form @submit.prevent="addNewRecipe">
      ...
      <div>
        ...
        <div>
          <div class="mb-3">
            <base-input type="file" identity="recipeImage" label="Photo Recipe" @input="checkImage"></base-input>
            <div>
              <img :src="recipeData.imageLink" :alt="recipeData.name" class="image">
            </div>
          </div>
          <div class="mb-3">
            <base-input type="text" identity="recipeTitle" placeholder="Give your recipe a title" label="Recipe Title"
              v-model="recipeData.name"></base-input>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3 mt-3"> <base-select class="mt-3" :data="['Breakfast', 'Lunch', 'Dinner', 'Meals', 'Snacks']"
              v-model="recipeData.category"></base-select> </div>
        </div>
      </div>
...
watchEffect(() => {
  if (props.isEdit) { // true jika di halaman edit
    ...
    if (valueEditRecipe) {
      ...
      recipeData.createAt = valueEditRecipe.createAt || recipeData.createAt; 
    }
  }
});
