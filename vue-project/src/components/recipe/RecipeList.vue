<template>
    ...
    <div class="col-12 col-lg-3 col-sm-4 position-relative" v-for="(recipe, index) in recipes" :key="recipe.id" style="padding-top: 12px; padding-bottom: 12px">
      <router-link :to="`/recipe/${recipe.id}`" class="card text-decoration-none" style="height: 398px;">
        <img :src="recipe.imageLink" :alt="recipe.name" class="card-img-top" height="240" width="285"style="object-fit: cover"/>
